...
ndjson-join 'd.id' setup/PostalSector-areas.ndjson setup/gb-census-report.ndjson | ndjson-map '{id: d[0].id, area_m2: d[0].area_m2, area_ha: d[1].area_ha, population: d[1].population, density_ha: d[1].population / ((d[1].area_ha == 0) ? Math.ceil(d[0].area_m2 / 10000.0) : d[1].area_ha), pdensity_ha: Math.max(1.0, +d[1].population) / ((d[1].area_ha == 0) ? Math.ceil(d[0].area_m2 / 10000.0) : d[1].area_ha)}' > output/gb-census-report-density.ndjson
